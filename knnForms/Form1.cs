    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           // Knn knn = new Knn();
            ...
            textBox15.Text = Convert.ToString(testy1);
            textBox17.Text = Convert.ToString(testy2);
            textBox18.Text = Convert.ToString(testy3);
        ...
        private void toolStripMenuItem1_Click(object sender, EventArgs e)  //tab1
        {

            Form2 lvFrm = new Form2();
            this.Hide(); //隐藏当前窗体
            lvFrm.Show();
        }

        private void tab3ToolStripMenuItem_Click(object sender, EventArgs e)//tab3
        {

        }

        private void tab2ToolStripMenuItem_Click(object sender, EventArgs e)//tab2
        {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            t1 = textBox16.Text;
            g = Convert.ToDouble(t1);         //   Get the value of the textbox1

            
        //    knn.distance(ref trainX1, ref trainX2, ref trainX3, ref trainX4, ref trainX5, ref trainY2, ref trainY1, ref trainY3, testx1, testx2, testx3, testx4, testx5, ref testy1, ref testy2, ref testy3);
            m1 = knn.calculateM(testy1, testx1, g, b, c, d, f);
            m2 = knn.calculateM(testy2, testx1, g, b, c, d, f);
            m3 = knn.calculateM(testy3, testx1, g, b, c, d, f);
